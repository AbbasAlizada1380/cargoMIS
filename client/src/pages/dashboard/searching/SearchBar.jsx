  ...
  <form onSubmit={handleSubmit} className="relative">
    <div className="relative group">
      <input
        ...
        className="w-full pr-12 pl-10 py-3 text-right text-gray-800 bg-white border border-gray-300 rounded-full focus:ring-3 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all duration-300 shadow-sm hover:shadow-md focus:shadow-lg focus:pl-12"
        dir="rtl"
        aria-label="Search"
        disabled={isLoading}
      />
