...
<div class="section">
  ...
  <ol class="regulations-list">
    <li class="regulation-item">شرکت افغان کارگو مکلف است تا از مسیر قانون محموله‌های خود را انتقال بدهد.</li>
    <li class="regulation-item">افغان کارگو مکلف به نگهداری از اجناس در تمام مواقع می‌باشد و در صورتی که ثابت شود در نتیجه بی تفاوتی کارمندان افغان کارگو به محموله آسیب رسیده است در مقابل مشتری جوابگو می‌باشیم.</li>
    <li class="regulation-item">افغان کارگو با استفاده از سیستم ردیابی معیاری خود که در وبسایت شرکت‌های بین‌المللی درج می‌باشد به مشتریان خود یک نمبر ردیابی ده رقمی ارائه می‌دارد که با آن نمبر مشتریان قابلیت ردیابی محموله خود را به طور ۲۴ ساعته از دوبی الی آدرس مقصد را داشته باشند.</li>
    <li class="regulation-item">افغان کارگو صرفاً مکلف به انتقال بسته‌ها بوده و در صورت مفقودی کلی و یا قسمی و همچنین تخریب کلی و یا قسمی محموله‌های که بیمه شده است و در ضمن توسط فرستنده ثابت شود مکلف به جبران خساره است. برای محموله‌های که بیمه نشده باشد طبق قوانین شرکت‌های بین‌المللی رسیدگی خواهد شد.</li>
    <li class="regulation-item">در صورت مواجه شدن با محدودیت در امور انتقال محموله توسط گمرکات کشور مبدأ، کشور مقصد یا کشورهای مسیر، افغان کارگو هیچ نوع مسؤولیت در این قبال ندارد.</li>
    <li class="regulation-item">در صورتی که گمرکات کشورهای مبدأ, مقصد و یا مسیر به محموله مشتری مشکوک گردد و بخواهند بررسی نمایند و در هنگام بازرسی سبب تخریب قسمتی یا کلی اجناس در اثر بریدگی یا برمه کاری گردد، افغان کارگو هیچ نوع مسؤولیت در این قبال ندارد.</li>
  </ol>
</div>
